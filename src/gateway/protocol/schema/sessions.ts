...
export const SessionHistoryListParamsSchema = Type.Object(
  {
    agentId: Type.Optional(NonEmptyString),
...
export const SessionHistoryGetParamsSchema = Type.Object(
  {
...
export const SessionHistoryImportParamsSchema = Type.Object(
  {
    agentId: NonEmptyString,
    files: Type.Array(
      Type.Object({
...
export const SessionHistoryExportParamsSchema = Type.Object(
  {
    agentId: NonEmptyString,
    sessionIds: Type.Array(NonEmptyString, { minItems: 1 }),
  },
  { additionalProperties: false },
);

export const SessionHistoryReindexParamsSchema = Type.Object(
  {
    agentId: Type.Optional(NonEmptyString),
  },
  { additionalProperties: false },
