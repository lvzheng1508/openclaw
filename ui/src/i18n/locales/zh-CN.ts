...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    sessionManagement: "按代理浏览本地会话历史。",
    historySession: "以只读方式查看单个会话转录。",
  ...
  sessionManagement: {
    title: "会话管理",
    subtitle: "按代理和日期范围浏览本地会话历史。",
    conflict: "冲突",
    skipExisting: "跳过已存在",
    overwrite: "覆盖",
    import: "导入",
    importTitle: "选择 .jsonl 文件导入（需要安全上下文）",
    export: "导出",
    ...
    startDate: "开始日期",
    endDate: "结束日期",
    connectHint: "连接到网关以加载会话历史。",
    selectAll: "全选",
    clearWithCount: "清除 ({count})",
    colIndex: "#",
    colTime: "时间",
    colSessionId: "会话 ID",
    colActions: "操作",
    noSessions: "未找到会话。",
    selectForExport: "选择导出",
    viewHistory: "查看",
    switchToChat: "切换",
    paginationSummary: "共 {total} 条 · 第 {page} / {totalPages} 页",
    previous: "上一页",
    next: "下一页",
  },
  historySession: {
    title: "历史会话",
    subtitle: "只读转录。切换到聊天以继续此会话。",
    backToList: "返回列表",
    switchToChat: "切换到聊天",
    agent: "代理",
    session: "会话",
