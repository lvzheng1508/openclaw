...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    sessionManagement: "Browse local transcript history across agents.",
    historySession: "Inspect one session transcript in read-only mode.",
  ...
  sessionManagement: {
    ...
    subtitle: "Browse local transcript history by agent and date range.",
    conflict: "Conflict",
    skipExisting: "Skip existing",
    overwrite: "Overwrite",
    import: "Import",
    importTitle: "Pick .jsonl files to import (requires secure context)",
    export: "Export",
    ...
    endDate: "End date",
    connectHint: "Connect to the gateway to load session history.",
    ...
    viewHistory: "View",
    switchToChat: "Switch",
    paginationSummary: "{total} total · page {page} / {totalPages}",
    previous: "Previous",
    next: "Next",
  },
  historySession: {
    title: "History Session",
    subtitle: "Read-only transcript. Switch to chat to continue this session.",
    ...
    noMessages: "No messages in this transcript.",
  },
  languages: {
    en: "English",
